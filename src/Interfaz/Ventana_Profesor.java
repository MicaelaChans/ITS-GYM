...
public class Ventana_Profesor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ventana_Profesor frame = new Ventana_Profesor();
	...
	public Ventana_Profesor() {
		...
		JLabel lblDatos_Profesor = new JLabel("Datos Profesor:");
		lblDatos_Profesor.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblDatos_Profesor.setBounds(256, 69, 137, 14);
		contentPane.add(lblDatos_Profesor);
		
		JLabel lblNombre = new JLabel("Nombre:");
		lblNombre.setBounds(10, 97, 62, 14);
		contentPane.add(lblNombre);
		
		JLabel lblApellido = new JLabel("Apellido:");
		lblApellido.setBounds(10, 122, 62, 14);
		contentPane.add(lblApellido);
		
		JLabel lblDocumento = new JLabel("Documento:");
		lblDocumento.setBounds(10, 147, 62, 14);
		contentPane.add(lblDocumento);
		
		JLabel lblTelfono = new JLabel("Teléfono:");
		lblTelfono.setBounds(10, 172, 62, 14);
		contentPane.add(lblTelfono);
		
		JLabel lblDireccin = new JLabel("Dirección:");
		lblDireccin.setBounds(280, 97, 69, 14);
		contentPane.add(lblDireccin);
		
		JLabel lblFechaDeNaciomiento = new JLabel("Fecha de Naciomiento:");
		lblFechaDeNaciomiento.setBounds(280, 122, 137, 14);
		contentPane.add(lblFechaDeNaciomiento);
		
		JLabel lblMembresa = new JLabel("Membresía:");
		lblMembresa.setBounds(280, 172, 89, 14);
		contentPane.add(lblMembresa);
		
		JLabel lblInformacinMdica = new JLabel("Información Médica:");
		lblInformacinMdica.setBounds(133, 204, 117, 14);
		contentPane.add(lblInformacinMdica);
		
		textField_Nombre = new JTextField();
		textField_Nombre.setColumns(10);
		textField_Nombre.setBounds(72, 94, 183, 20);
		contentPane.add(textField_Nombre);
		
		textField_Apellido = new JTextField();
		textField_Apellido.setColumns(10);
		textField_Apellido.setBounds(72, 119, 183, 20);
		contentPane.add(textField_Apellido);
		
		textField_Documento = new JTextField();
		textField_Documento.setColumns(10);
		textField_Documento.setBounds(72, 144, 183, 20);
		contentPane.add(textField_Documento);
		
		textField_Telefono = new JTextField();
		textField_Telefono.setColumns(10);
		textField_Telefono.setBounds(72, 169, 183, 20);
		contentPane.add(textField_Telefono);
		
		textField_Direccion = new JTextField();
		textField_Direccion.setColumns(10);
		textField_Direccion.setBounds(413, 94, 183, 20);
		contentPane.add(textField_Direccion);
		
		textField_FechaNacimiento = new JTextField();
		textField_FechaNacimiento.setColumns(10);
		textField_FechaNacimiento.setBounds(413, 119, 183, 20);
		contentPane.add(textField_FechaNacimiento);
		
		textField_Membresia = new JTextField();
		textField_Membresia.setColumns(10);
		textField_Membresia.setBounds(413, 169, 183, 20);
		...
		comboBox_InfoMedica.setBounds(260, 197, 183, 22);
